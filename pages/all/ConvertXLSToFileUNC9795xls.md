{
    "title" : "How do I Convert a Microsoft Excel Spreadsheet to a xls and save it to a UNC network Drive?  " 
}

How do I Convert a Microsoft Excel Spreadsheet to a xls and save it to a UNC network Drive? 
==

How do I Convert a Microsoft Excel Spreadsheet to a Excel 97/95 format (xls) and write it to a UNC Path?         
-
...
The command line below shows how you can convert a Microsoft Excel Spreadsheet Document to a Excel 97/95 format file - xls and save it to a UNC path.

Command Line 
-

 ````
 docto -XL -f '\\MyServer\path\Spreadsheet.xls' -o '\\\\myserver\path\Output\Spreadsheet.xls' -t xlExcel9795
 ````
 ...
 docto -XL  -f '\\MyServer\path\Spreadsheet.xls' 
            -o '\\\\myserver\path\Output\Spreadsheet.xls'
            -t xlExcel9795
 ````
