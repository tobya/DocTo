...
Here we set the log level to `5` which is  defined as 'Chatty' which can be explained as Will provide some more information about the process of conversion

Command Line 
-

 ````
 docto -WD -f 'c:\path\Document.doc' -o 'c:\path\Document.PDF' -t wdFormatPDF -L 5
 ````
 or easier to read
 ````
