{
    "title" : "How do I Convert a Microsoft Excel Spreadsheet to a TXT and save it to a UNC network Drive?  " 
}

How do I Convert a Microsoft Excel Spreadsheet to a TXT and save it to a UNC network Drive? 
==

How do I Convert a Microsoft Excel Spreadsheet to a Text File (TXT) and write it to a UNC Path?         
-
...
The command line below shows how you can convert a Microsoft Excel Spreadsheet Document to a Text File file - TXT and save it to a UNC path.

Command Line 
-

 ````
 docto -XL -f '\\MyServer\path\Spreadsheet.xls' -o '\\\\myserver\path\Output\Spreadsheet.TXT' -t xlTextWindows
 ````
 ...
 docto -XL  -f '\\MyServer\path\Spreadsheet.xls' 
            -o '\\\\myserver\path\Output\Spreadsheet.TXT'
            -t xlTextWindows
 ````
