...
How do I delete a file after Converting it to a Filtered HTML File (HTML)?         
-
...
The command line below shows how you can convert all the Microsoft Word Documents in a folder to a Filtered HTML File (HTML) file and then remove the file.

Command Line 
-

 ````
 docto -WD -f 'c:\path\todocuments' -o 'c:\path\toOutputfiles' -t wdFormatFilteredHTML -R true
 ````
 or easier to read
 ````
 docto  -WD 
